<template>
    <div class="subheader w-100 mb-4">
        <div class="row align-items-center">
            <div class="col-12">
                <h1>Настройки страницы "Прайс-лист"</h1>
            </div>
        </div>
    </div>
...
export default {
    ...
    created() {
        this.loadPricelistPage()
    },
    methods: {
        loadPricelistPage() {
            axios.get('/_admin/pricelist-page')
            .then(response => {
                this.pricelistPage = response.data
        ...
        save() {
            ...
            axios.post('/_admin/pricelist-page', {
