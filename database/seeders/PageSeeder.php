    ...
    public function run()
    {
        DB::table('pages')->insert([
            [
                ...
                'desc2_title' => 'Заголовок для блока с текстом 2',
                'desc2_text' => 'Текст для блока с текстом 2',
            ],
            [
                'id' => 2,
            ...
            [
                'id' => 6,
                'name' => 'Эвакуатор для спецтехники',
                'slug' => 'evakuator-dlya-spectekhniki',
                'price' => 4000,
                'order' => 6,
                'icon' => '/img/spez.png',
                'meta_title' => 'Эвакуатор для спецтехники',
                'meta_description' => 'Краткое описание для Эвакуатор для спецтехники',
                'desc1_title' => 'Заголовок для блока с текстом',
                'desc1_text' => 'Текст для блока с текстом',
                'desc2_title' => 'Заголовок для блока с текстом 2',
                'desc2_text' => 'Текст для блока с текстом 2',
